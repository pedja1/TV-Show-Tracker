/*
    ...
    Modified my Predrag Cokulov for use with DatingVIP
*/

package rs.pedjaapps.tvshowtracker.network.cookie;
...
/**
 * A persistent cookie store which implements the Apache HttpClient {@link ch.boye.httpclientandroidlib.client.CookieStore} interface.
...
public class PersistentCookieStore implements CookieStore
{
    ...
    Cookie decodeCookie(String cookieString)
    {
        ...
        {
            if(BuildConfig.DEBUG)Log.d(LOG_TAG, "decodeCookie failed", exception);
