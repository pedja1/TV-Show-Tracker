...
public class ShowOld
{
    ...
    public ShowOld(String banner) {
		super();
		this.banner = banner;
	}

	public ShowOld(String seriesName, String overview, int seriesId,
	...
	public ShowOld(String seriesName, String banner, String nextEpisode, int prgWatched, int seriesId, int nextEpisodeDays){
    	this.seriesName = seriesName;
		this.banner = banner;
	...
	public ShowOld(String seriesName, String firstAired, String imdbId,
