...
public class Show {
    ...
    public List<Actor> getActors() {
        if (actors == null) {
            ...
            List<Actor> actorsNew = targetDao._queryShow_Actors(tvdb_id);
            synchronized (this) {
                if(actors == null) {
                    actors = actorsNew;
                }
    ...
    public List<Genre> getGenres() {
        if (genres == null) {
            ...
            List<Genre> genresNew = targetDao._queryShow_Genres(tvdb_id);
            synchronized (this) {
                if(genres == null) {
                    genres = genresNew;
                }
    ...
    public List<Episode> getEpisodes() {
        if (episodes == null) {
            ...
            List<Episode> episodesNew = targetDao._queryShow_Episodes(tvdb_id);
            synchronized (this) {
                if(episodes == null) {
