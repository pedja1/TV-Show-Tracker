...
public class DatabaseHandler extends SQLiteOpenHelper
{
	...
	private static final String[] show_filds = {"_id", "series_name", 
		...
		"ignore_agenda", "hide_from_list", "updated", "actors", "profile_name"};
	private static final String[] episode_filds = {"_id", "episode", 
		"season", "episode_name", "first_aired", "imdb_id", "overview", 
		"rating", "watched", "episode_id", "profile_name"};
	private static final String[] actors_filds = {"_id", "actor_id", "name", "role", "image","profile_name"};
    ...
    public void onCreate(SQLiteDatabase db)
	{
    	...
    	String CREATE_PROFILES_TABLE = "CREATE TABLE " + TABLE_PROFILES + "("
    			+ profile_filds[0] + " INTEGER PRIMARY KEY,"
    			+ profile_filds[1] + " TEXT"
    			+
    			")";
    ...
    public void createActorsTable(String seriesId){
    	SQLiteDatabase db = this.getWritableDatabase();
    	String CREATE_ACTORS_TABLE = "CREATE TABLE IF NOT EXISTS actors_" + seriesId + "("
	...
	/**
	 * @param filter Can be either all, continuing, or ended*/
	public List<Show> getAllShows(String filter, String profile)
	{
        ...
        String selectQuery = builder.toString();//"SELECT  * FROM " + TABLE_SERIES;
	...
	public boolean showExists(String seriesName, String profile) {
        ...
        Cursor cursor = db.query(TABLE_SERIES, show_filds, show_filds[1] + "=? and profile_name LIKE \"%"+profile+"%\"",
	...
	{
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TABLE_SERIES, show_filds[2] + " = ? and profile_name LIKE \"%"+profile+"%\"",
				  new String[] { seriesId });
	...
	public Show getShow(String seriesId, String profile)
	{
        ...
        Cursor cursor = db.query("series", show_filds, show_filds[2] + "=? and profile_name LIKE \"%"+profile+"%\"",
	...
	public EpisodeItem getEpisode(String seriesId, String episodeId, String profile)
	{
        SQLiteDatabase db = this.getReadableDatabase();

        Cursor cursor = db.query("episodes_"+seriesId, episode_filds, episode_filds[9] + "=? and profile_name LIKE \"%"+profile+"%\"",
	...
	public Actor getActor(String seriesId, String actorId, String profile)
	{
        ...
        Cursor cursor = db.query("actors_"+seriesId, actors_filds, actors_filds[1] + "=? and profile_name LIKE \"%"+profile+"%\"",
								 new String[] { actorId }, null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
	...
	public List<EpisodeItem> getAllEpisodes(String seriesId, String profile)
	{
        ...
        // Select All Query
        String selectQuery = "SELECT  * FROM episodes_" + seriesId + " WHERE profile_name LIKE \"%"+profile+"%\"";
	...
	public List<Actor> getAllActors(String seriesId, String profile)
	{
        ...
        // Select All Query
        String selectQuery = "SELECT  * FROM actors_" + seriesId + " WHERE profile_name LIKE \"%"+profile+"%\"";
	...
	public boolean episodeExists(String seriesId, String episodeId, String profile) {
    	SQLiteDatabase db = this.getReadableDatabase();
	...
	public int updateEpisode(EpisodeItem e, String episodeId, String seriesId)
	{
        ...
        int count = db.update("episodes_"+seriesId, values, episode_filds[9] + " = ?  and profile_name LIKE \"%"+e.getProfile()+"%\"",
	...
	public int updateActor(Actor a, String actorId, String seriesId)
	{
        ...
        int count = db.update("actors_"+seriesId, values, actors_filds[1] + " = ?  and profile_name LIKE \"%"+a.getProfile()+"%\"",
						 new String[] { actorId });
        db.close();
        return count;
        }
	...
	{
        String countQuery = "SELECT  * FROM episodes_" + seriesId + " WHERE profile_name LIKE \"%"+profile+"%\"";
        SQLiteDatabase db = this.getReadableDatabase();
